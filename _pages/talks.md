...
<ol class="bibliography">
  ...
  <li>
    <div class="row">
      <div class="col-sm-10">
        <div class="title"><strong>Invited.</strong> Nordic Workshop on AI for Climate Change (Gothenburg, Sweden)</div>
        <div class="author"><em>Machine learning for atmospheric mass spectrometry</em></div>
      </div>
    </div>
  </li>
</ol>
